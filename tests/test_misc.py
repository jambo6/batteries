...
def test_ragged_tensor_list_to_tensor():
    ...
    list_arrays = [[[1, 2, 3], [3, 4, float('nan')]], [[1, 2, float('nan')], [5, 6, 1], [9, 10, 2]]]
    ...
    for fill_value in [float('nan'), 0.]:
        tensor, length = misc.ragged_tensor_list_to_tensor(tensor_list, fill_value=fill_value)
